...
class _DriverOnboardingScreenState
  ...
  Widget build(BuildContext context) {
    // Keep driverProfileProvider alive while updateProfile() is in flight.
    // Without this watch, the auto-dispose notifier can be collected between
    // the AsyncLoading state set and the async guard completing, causing
