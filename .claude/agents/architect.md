...
name: architect
description: >-
  Use for system design, module boundaries, trade-off analysis, database schema
...
- Ensure the Domain layer has zero Flutter or backend-framework imports
...
apps/mobile/lib/features/<name>/
  data/          ← backend implementations, DTOs, mappers
